...
img: Clean-Internet-Explorer-cache.png # Add image post (optional)
...
Function ShowHelp
{
	...
	Write-Host ""
	Write-Host "Version $Version by Berry de Jager"
}
...
{	
	...
	$objForm.Text = "PPG Internet Explorer Cache Cleaner"
